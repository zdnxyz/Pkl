                                ...
                                <div class="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{url('/productinfo')}}" class="product-details">Flower Design Skart
                                            </a>
                                            <div class="price">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{url('/productinfo')}}" class="product-details">Red Party Dress
                                            </a>
                                            <div class="price">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{url('/productinfo')}}" class="product-details">White T-Shirt
                                            </a>
                                            <div class="price">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{url('/productinfo')}}" class="product-details">Sleeveless Dress
                                            </a>
                                            <div class="price">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{url('/productinfo')}}" class="product-details">Rainbow Sequin Shirt
                                            </a>
                                            <div class="price">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{url('/productinfo')}}" class="product-details">Tom Checked shirt
                                            </a>
                                            <div class="price">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{url('/productinfo')}}" class="product-details">Rainbow Baby Dress
                                            </a>
                                            <div class="price">
                                                <span class="price-cut">$29.99</span>
                                                <span class="new-price">$16.99</span>
